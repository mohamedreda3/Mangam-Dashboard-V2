...
function Addition() {
  ...
  const addProduct = () => {
    ...
    axios
      .post("http://localhost:9999/v2/product/add_product", data_send)
      .then((res) => {
  ...
  const handleaddbanner = () => {
    ...
    axios
      .post("http://localhost:9999/v2/banner/add_banner", data_send)
      .then((res) => {
        // console.log(res)
        if (res.data.status == 1) {
          toast.success(res.data.message);
  ...
  const handleaddcategory = () => {
    ...
    // console.log(data_send);
    axios
      .post("http://localhost:9999/v2/category/add", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          toast.success(res.data.message);
          window.location.reload();
