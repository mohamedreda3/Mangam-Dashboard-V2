...
const Products = () => {
          ...
          >
            <img
              onClick={() => {
                ...
                axios
                  .post(
                    "http://localhost:9999/v2/product/updateHidden",
                    data_send
                  )
                  .then((res) => {
  ...
  const handleeditproduct = () => {
    ...
    console.log(data_send);
    axios
      .post("http://localhost:9999/v2/product/edit_product")
      .then((res) => {
        console.log(res.data);
        if (res.data.status == 1) {
          toast.success(res.data.message);
  ...
  const exportFunction = () => {
    axios
      .post(
        "http://localhost:9999/v2/site/info/export?type=admin&dataName=product"
      )
      .then((res) => {
