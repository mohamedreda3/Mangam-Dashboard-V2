...
const EditProduct = () => {
  ...
  const getproductbyid = () => {
    axios
      .get(`http://localhost:9999/v2/product/getProduct?id=${record.id}`)
      .then((res) => {
  ...
  const getcategories = async () => {
    await axios
      .get("http://localhost:9999/v2/category/getAll?type=admin")
      .then((res) => {
  ...
  const handleaddcolor = (item) => {
    ...
    axios
      .post("http://localhost:9999/v2/color/add", data_send)
      .then((res) => {
  ...
  const handleaddproperity = (it, item, index, ind) => {
    ...
    axios
      .post("http://localhost:9999/v2/color_props/add", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          getproductbyid();
          toast.success(
  ...
  const handleaddPropsValue = (data) => {
    ...
    axios
      .post("http://localhost:9999/v2/color_props/add_value", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          getproductbyid();
          toast.success(res.data.message);
  ...
  const handleeditpropvalue = (itPropValue) => {
    ...
    axios
      .post("http://localhost:9999/v2/color_props/edit_value", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          toast.success(res.data.message);
          getproductbyid();
  ...
  const handleeditcolor = (data, i) => {
    ...
    axios
      .post("http://localhost:9999/v2/color/edit", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          getproductbyid();
          toast.success(res.data.message);
  ...
  const handleeditprop = (itProp, indProp, index) => {
    ...
    axios
      .post("http://localhost:9999/v2/color_props/edit", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          getproductbyid();
          toast.success(res.data.message);
  ...
  const handleeditproductdata = () => {
    ...
    axios
      .post("http://localhost:9999/v2/product/edit_product", data_send)
      .then((res) => {
        // console.log(res.data)
        if (res.data.status == 1) {
          toast.success(res.data.message);
                            ...
                            >
                              ...
                              <button
                                onClick={() => {
                                  ...
                                  axios
                                    .post(
                                      "http://localhost:9999/v2/color_props/delete",
                                      data_send
                                    )
                                    .then((res) => {
                                      if (res.data.status == 1) {
                                  ...
                                  >
                                    ...
                                    <button
                                      onClick={() => {
                                        ...
                                        axios
                                          .post(
                                            "http://localhost:9999/v2/color_props/delete_value",
                                            data_send
                                          )
                                          .then((res) => {
                                            if (res.data.status == 1) {
