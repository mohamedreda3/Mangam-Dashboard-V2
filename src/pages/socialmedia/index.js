...
const SocialMedia = () => {
  ...
  const getSocials = () => {
    axios
      .post("http://localhost:9999/v2/site/social_media/getAll?type=admin")
      .then((res) => {
  ...
  const handleadd = () => {
    ...
    axios
      .post("http://localhost:9999/v2/site/social_media/add", data_send)
      .then((res) => {
        // console.log(res.data);
  ...
  const handleedit = () => {
    ...
    // console.log(data_send);
    axios
      .post("http://localhost:9999/v2/site/social_media/edit", data_send)
      .then((res) => {
        if (res.data.status == 1) {
          getSocials();
          toast.success(res.data.message);
            ...
            {changeloading.id == record.id ? (
              ...
              <img
                onClick={() => {
                  ...
                  axios
                    .post(
                      "http://localhost:9999/v2/site/social_media/updateHidden",
                      data_send
                    )
                    .then((res) => {
                      if (res.data.status == 1) {
